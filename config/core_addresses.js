...
const allAddresses = {
  ...
  contracts: {
    ...
    DHashTokenUtility: {
      address: process.env.OST_DHashTokenUTILITY_CONTRACT_ADDR,
      abi: coreAbis.DHashTokenUtility,
      bin: coreBins.DHashTokenUtility
    },

    DHashTokenValue: {
      address: process.env.OST_DHashTokenVALUE_CONTRACT_ADDR,
      abi: coreAbis.DHashTokenValue,
      bin: coreBins.DHashTokenValue
    },
