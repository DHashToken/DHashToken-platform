...
const coreConstants = require('../config/core_constants')
      ,VC_RPC = coreConstants.OST_GETH_VALUE_RPC_PROVIDER
      ,VC_WS = coreConstants.OST_GETH_VALUE_WS_PROVIDER
      ,UC_RPC = coreConstants.OST_GETH_UTILITY_RPC_PROVIDER
      ,UC_WS = coreConstants.OST_GETH_UTILITY_CHAIN_RPC_PROVIDER
;


const Geth = module.exports = {};

Geth.ValueChain = new Web3(new Web3.providers.HttpProvider( VC_RPC ));
